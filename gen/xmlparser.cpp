...
namespace xml
{
void XMLParser_xmlSAX2StartElement(void* ctx, const XML_Char* fullname,
                                   const XML_Char** atts)
{
...
bool XmlParser::parseFile(const std::string& filename)
{
    ...
    XML_SetElementHandler(saxHandler, XMLParser_xmlSAX2StartElement,
...
const XML_Char* XmlParser::xmlGetAttrValue(const XML_Char** attrs,
                                           const XML_Char* key)
{
    if (attrs != NULL)
    {
