...
{
public:
    using Variant = std::variant<std::string, Integer, Float, Boolean, Null, Array, Object>;
...
// ============================================================================
template <>
std::optional<std::string> Value::as<std::string>() const noexcept;
template <>
std::optional<Integer> Value::as<Integer>() const noexcept;
template <>
std::optional<int> Value::as<int>() const noexcept;
template <>
std::optional<Float> Value::as<Float>() const noexcept;
template <>
std::optional<Boolean> Value::as<Boolean>() const noexcept;
template <>
std::optional<Null> Value::as<Null>() const noexcept;
template <>
std::optional<Array> Value::as<Array>() const noexcept;
template <>
std::optional<Object> Value::as<Object>() const noexcept;
...
template <typename T>
void Object::insert(std::string key, T&& value)
{
...
size_t Object::erase(const std::string& key) noexcept
{
...
auto Object::begin() noexcept
{
    return fields.begin();
}
auto Object::end() noexcept
{
    return fields.end();
}
auto Object::begin() const noexcept
{
    return fields.begin();
}
auto Object::end() const noexcept
{
    return fields.end();
}
