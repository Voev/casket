...
void ping_handler(const std::vector<uint8_t>& request, std::vector<uint8_t>& response)
{
    (void)request;
    response = {'p', 'o', 'n', 'g'};
...
void echo_handler(const std::vector<uint8_t>& request, std::vector<uint8_t>& response)
{
...
void math_handler(const std::vector<uint8_t>& request, std::vector<uint8_t>& response)
{
...
void stats_handler(const std::vector<uint8_t>& request, std::vector<uint8_t>& response)
{
    if (request.empty())
    {
    ...
    std::string result = "Sum: " + std::to_string(sum) + ", Mean: " + std::to_string(mean) +
                         ", Min: " + std::to_string(*min_it) + ", Max: " + std::to_string(*max_it);
...
void info_handler(const std::vector<uint8_t>& request, std::vector<uint8_t>& response)
{
    (void)request;
